...
public class MasheryClientTest extends TestCase {
    ...
    @Test
    public void testcreateResourceAndReturnId() {
        resource = new MasheryService();
        assertEquals(resourceId, client.createResourceAndReturnId(resource).getResponse());
    }
     ...
     */
    @Test
    public void testcreateResourceAndReturnIdMissingParams() {

        client = MasheryClientBuilder.masheryClient().withHost(host).withProtocol("http").withPort(port).withApiKey("wrongKey").withApiSecret(apiSecret).withTokenRequestParams(params).build();

        resource = new MasheryPackage();
        assertNull(client.createResourceAndReturnId(resource).getResponse());
    }
    ...
    public void testNullResources() {
        assertNull(client.createResourceAndReturnId(null).getResponse());
    ...
    public void testReadOnly() {
        ...
        assertNull(client.createResourceAndReturnId(new MasheryPlan()).getResponse());
